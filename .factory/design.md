...
The three desktop walkthrough images were captured on 2026-08-29 from this repository's own built interface in Chromium at 1200 × 750. Source PNGs are retained in `assets/src/`; optimized WebP files ship in `public/assets/`. They contain no third-party material.
